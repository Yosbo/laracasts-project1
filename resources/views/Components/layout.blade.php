        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <x-nav-link href="/" type='a' :active="request()->is('/')">Dashboard</x-nav-link>
              <x-nav-link href="/expenses" type="a" :active="request()->is('expenses')">Expenses</x-nav-link>
              <x-nav-link href="/income" type="a" :active="request()->is('income')">Income</x-nav-link>
              <x-nav-link href="/summary" type="button" :active="request()->is('summary')">Summary</x-nav-link>
            </div>
          </div>
        </div>
        <div class="hidden md:block">
